...
CREATE TABLE `material_brand` (
  `material_brand_id` int NOT NULL AUTO_INCREMENT,
  `material_brand_name` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`material_brand_id`),
  UNIQUE KEY `material_brand_id_UNIQUE` (`material_brand_id`)
...
INSERT INTO `material_brand` VALUES (1,'TMT'),(2,'Ambuja'),(3,'Polycab');
...
-- Dump completed on 2024-03-27 19:04:02
